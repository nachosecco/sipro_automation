...
from core.devices import DEVICE_TABLET_APPLE_IOS
...
def test_bid_request_tablet_device_info_rtb26():
    case = Case(
        "test_bid_request_tablet_device_info_rtb26"
...
# This would test device info against tablet device Roku device vendor for version 2.5
@pytest.mark.regression
def test_bid_request_tablet_device_info_rtb25():
    case = Case(
        "test_bid_request_tablet_device_info_rtb25"
    )  # This is the file to test this case
...
# This would test device info against tablet device Roku device vendor for version 2.4
@pytest.mark.regression
def test_bid_request_tablet_device_info_rtb24():
    case = Case(
        "test_bid_request_tablet_device_info_rtb24"
    )  # This is the file to test this case
...
# This would test device info against tablet device Roku device vendor for version 2.3
@pytest.mark.regression
def test_bid_request_tablet_device_info_rtb23():
    case = Case(
        "test_bid_request_tablet_device_info_rtb23"
    )  # This is the file to test this case
    ...
    validate_rtb_ctv_common_properties(
        bid_request_validator, "test_bid_request_tablet_device_info_rtb23"
    )
...
# This would test device info against tablet device Roku device vendor for version 2.2
@pytest.mark.regression
def test_bid_request_tablet_device_info_rtb22():
    case = Case(
        "test_bid_request_tablet_device_info_rtb22"
    )  # This is the file to test this case

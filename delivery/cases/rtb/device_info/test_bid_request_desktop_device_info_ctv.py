...
from core.devices import DEVICE_DESKTOP_MAC
...
# This would test device info against connetedTV desktop Roku device vendor for version 2.6
@pytest.mark.regression
def test_bid_request_desktop_device_info_rtb26():
    case = Case(
        "test_bid_request_desktop_device_info_rtb26"
...
# This would test device info against device desktop Roku device vendor for version 2.5
@pytest.mark.regression
def test_bid_request_desktop_device_info_rtb25():
    case = Case(
        "test_bid_request_desktop_device_info_rtb25"
    )  # This is the file to test this case
...
# This would test device info against device desktop Roku device vendor for version 2.4
@pytest.mark.regression
def test_bid_request_desktop_device_info_rtb24():
    case = Case(
        "test_bid_request_desktop_device_info_rtb24"
    )  # This is the file to test this case
...
# This would test device info against desktop Roku device vendor for version 2.3
@pytest.mark.regression
def test_bid_request_desktop_device_info_rtb23():
    case = Case(
        "test_bid_request_desktop_device_info_rtb23"
    )  # This is the file to test this case
    ...
    validate_rtb_ctv_common_properties(
        bid_request_validator, "test_bid_request_desktop_device_info_rtb23"
    )
...
# This would test device info against desktop Roku device vendor for version 2.2
@pytest.mark.regression
def test_bid_request_desktop_device_info_rtb22():
    case = Case(
        "test_bid_request_desktop_device_info_rtb22"
    )  # This is the file to test this case

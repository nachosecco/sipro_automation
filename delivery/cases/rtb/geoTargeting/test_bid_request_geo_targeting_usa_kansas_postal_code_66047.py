...
# Validating the geo targeting in RTB version 2.2 for country USA and State Kansas
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb22_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb22_valid"
...
# Validating the geo targeting in RTB version 2.3 for country USA and State Kansas
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb23_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb23_valid"
    )  # This is the file to test this case
...
# Validating the geo targeting in RTB version 2.4 for country USA and State Kansas
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb24_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb24_valid"
    )  # This is the file to test this case
...
# Validating the geo targeting in RTB version 2.5 for country USA and State Kansas
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb25_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb25_valid"
    )  # This is the file to test this case
...
# Validating the geo targeting in RTB version 2.6 for country USA and State Kansas
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb26_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb26_valid"
    )  # This is the file to test this case
...
# Test RTB 2.2 bid request for CTV placement geo targeting country USA and State Kansas negative
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb22_negative():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb22_negative"
    )  # This is the file to test this case
...
# Test RTB 2.3 bid request for CTV placement geo targeting country USA and State Kansas negative
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb23_negative():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb23_negative"
    )  # This is the file to test this case
...
# Test RTB 2.4 bid request for CTV placement geo targeting country USA and State Kansas negative
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb24_negative():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb24_negative"
    )  # This is the file to test this case
...
# Test RTB 2.5 bid request for CTV placement geo targeting country USA and State Kansas negative
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb25_negative():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb25_negative"
    )  # This is the file to test this case
...
# Test RTB 2.6 bid request for CTV placement geo targeting country USA and State Kansas negative
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb26_negative():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_postal_code_66047_rtb26_negative"
    )  # This is the file to test this case

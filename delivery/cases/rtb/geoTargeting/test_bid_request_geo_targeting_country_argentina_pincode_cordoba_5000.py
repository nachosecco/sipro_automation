...
# Test RTB 2.2 bid request for geo targeting country argentina pincode cordoba 5000.
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb22_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb22_valid"
    )  # This is the file to test this case

    vpc = case.vpc
    vpc.did = "fe088fc1-4cb4-548e-989b-6f8ff834e27d"
    vpc.ip_address = get_ip_for_geo(country="AR", region="Cordoba", postcode="5000")
...
# Test RTB 2.3 bid request for CTV placement geo targeting country argentina pincode cordoba 5000.
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb23_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb23_valid"
    )  # This is the file to test this case
...
# Test RTB 2.4 bid request for CTV placement geo targeting country argentina pincode cordoba 5000.
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb24_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb24_valid"
    )  # This is the file to test this case
...
# Test RTB 2.5 bid request for CTV placement geo targeting country argentina pincode cordoba 5000.
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb25_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb25_valid"
    )  # This is the file to test this case
...
# Test RTB 2.6 bid request for CTV placement geo targeting country argentina pincode cordoba 5000.
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb26_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb26_valid"
    )  # This is the file to test this case
...
# Test RTB 2.2 bid request for CTV placement geo targeting country argentina pincode cordoba 5000 negative
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb22_invalid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb22_invalid"
    )  # This is the file to test this case

    vpc = case.vpc
    vpc.did = "fe088fc1-4cb4-548e-989b-6f8ff834e27d"
    vpc.ip_address = get_ip_not_for_geo(country="AR", region="Cordoba", postcode="5000")
...
# Test RTB 2.3 bid request for CTV placement geo targeting country argentina pincode cordoba 5000 negative
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb23_invalid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb23_invalid"
    )  # This is the file to test this case
...
# Test RTB 2.4 bid request for CTV placement geo targeting country argentina pincode cordoba 5000 negative
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb24_invalid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb24_invalid"
    )  # This is the file to test this case
...
# Test RTB 2.5 bid request for CTV placement geo targeting country argentina pincode cordoba 5000 negative
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb25_invalid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb25_invalid"
    )  # This is the file to test this case
...
# Test RTB 2.6 bid request for CTV placement geo targeting country argentina pincode cordoba 5000 negative
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb26_invalid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_pincode_cordoba_5000_rtb26_invalid"
    )  # This is the file to test this case

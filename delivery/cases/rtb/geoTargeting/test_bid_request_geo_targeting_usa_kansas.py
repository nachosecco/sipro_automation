...
def test_bid_request_geo_targeting_for_country_usa_kansas_rtb22_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_rtb22_valid"
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_rtb23_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_rtb23_valid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_rtb24_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_rtb24_valid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_rtb25_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_rtb25_valid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_rtb26_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_rtb26_valid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_rtb22_negative():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_rtb22_negative"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_rtb23_negative():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_rtb23_negative"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_rtb24_negative():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_rtb24_negative"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_rtb25_negative():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_rtb25_negative"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_usa_kansas_rtb26_negative():
    case = Case(
        "test_bid_request_geo_targeting_for_country_usa_kansas_rtb26_negative"
    )  # This is the file to test this case

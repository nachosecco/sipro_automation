...
# Test RTB 2.2 bid request for CTV placement geo targeting country canada city toronto
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb22_country_canada_city_toronto_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb22_country_canada_city_toronto_valid"
...
# Test RTB 2.3 bid request for CTV placement geo targeting country canada city toronto
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb23_country_canada_city_toronto_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb23_country_canada_city_toronto_valid"
    )  # This is the file to test this case
...
# Test RTB 2.4 bid request for CTV placement geo targeting country canada city toronto
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb24_country_canada_city_toronto_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb24_country_canada_city_toronto_valid"
    )  # This is the file to test this case
...
# Test RTB 2.5 bid request for CTV placement geo targeting country canada city toronto
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb25_country_canada_city_toronto_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb25_country_canada_city_toronto_valid"
    )  # This is the file to test this case
...
# Test RTB 2.6 bid request for CTV placement geo targeting country canada city toronto
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb26_country_canada_city_toronto_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb26_country_canada_city_toronto_valid"
    )  # This is the file to test this case
...
# Test RTB 2.2 bid request for CTV placement geo targeting country canada city toronto negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb22_country_canada_city_toronto_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb22_country_canada_city_toronto_negative"
    )  # This is the file to test this case
...
# Test RTB 2.3 bid request for CTV placement geo targeting country canada city toronto negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb23_country_canada_city_toronto_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb23_country_canada_city_toronto_negative"
    )  # This is the file to test this case
...
# Test RTB 2.4 bid request for CTV placement geo targeting country canada city toronto negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb24_country_canada_city_toronto_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb24_country_canada_city_toronto_negative"
    )  # This is the file to test this case
...
# Test RTB 2.5 bid request for CTV placement geo targeting country canada city toronto negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb25_country_canada_city_toronto_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb25_country_canada_city_toronto_negative"
    )  # This is the file to test this case
...
# Test RTB 2.6 bid request for CTV placement geo targeting country canada city toronto negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb26_country_canada_city_toronto_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb26_country_canada_city_toronto_negative"
    )  # This is the file to test this case

...
# Test RTB 2.2 bid request for CTV placement geo targeting country canada
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb22_country_canada_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb22_country_canada_valid"
...
# Test RTB 2.3 bid request for CTV placement geo targeting country canada
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb23_country_canada_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb23_country_canada_valid"
    )  # This is the file to test this case
...
# Test RTB 2.4 bid request for CTV placement geo targeting country canada
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb24_country_canada_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb24_country_canada_valid"
    )  # This is the file to test this case
...
# Test RTB 2.5 bid request for CTV placement geo targeting country canada
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb25_country_canada_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb25_country_canada_valid"
    )  # This is the file to test this case
...
# Test RTB 2.6 bid request for CTV placement geo targeting country canada
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb26_country_canada_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb26_country_canada_valid"
    )  # This is the file to test this case
...
# Test RTB 2.2 bid request for CTV placement geo targeting country canada negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb22_country_canada_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb22_country_canada_negative"
    )  # This is the file to test this case
...
# Test RTB 2.3 bid request for CTV placement geo targeting country canada negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb23_country_canada_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb23_country_canada_negative"
    )  # This is the file to test this case
...
# Test RTB 2.4 bid request for CTV placement geo targeting country canada negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb24_country_canada_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb24_country_canada_negative"
    )  # This is the file to test this case
...
# Test RTB 2.5 bid request for CTV placement geo targeting country canada negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb25_country_canada_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb25_country_canada_negative"
    )  # This is the file to test this case
...
# Test RTB 2.6 bid request for CTV placement geo targeting country canada negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb26_country_canada_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb26_country_canada_negative"
    )  # This is the file to test this case

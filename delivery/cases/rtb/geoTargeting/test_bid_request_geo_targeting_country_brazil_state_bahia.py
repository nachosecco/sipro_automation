...
# Test RTB 2.2 bid request for CTV placement geo targeting country brazil state bahia
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb22_country_brazil_state_bahia_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb22_country_brazil_state_bahia_valid"
    )  # This is the file to test this case

    vpc = case.vpc
    vpc.did = "fe088fc1-4cb4-548e-989b-6f8ff834e27d"
    vpc.ip_address = get_ip_for_geo(
        country="BR", region="Bahia", city="Salvador", postcode="40000"
    )
...
# Test RTB 2.3 bid request for CTV placement geo targeting country brazil state bahia
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb23_country_brazil_state_bahia_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb23_country_brazil_state_bahia_valid"
    )  # This is the file to test this case
...
# Test RTB 2.4 bid request for CTV placement geo targeting country brazil state bahia
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb24_country_brazil_state_bahia_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb24_country_brazil_state_bahia_valid"
    )  # This is the file to test this case
...
# Test RTB 2.5 bid request for CTV placement geo targeting country brazil state bahia
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb25_country_brazil_state_bahia_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb25_country_brazil_state_bahia_valid"
    )  # This is the file to test this case
...
# Test RTB 2.6 bid request for CTV placement geo targeting country brazil state bahia
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb26_country_brazil_state_bahia_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb26_country_brazil_state_bahia_valid"
    )  # This is the file to test this case
...
# Test RTB 2.2 bid request for CTV placement geo targeting country brazil state bahia negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb22_country_brazil_state_bahia_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb22_country_brazil_state_bahia_negative"
    )  # This is the file to test this case
...
# Test RTB 2.3 bid request for CTV placement geo targeting country brazil state bahia negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb23_country_brazil_state_bahia_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb23_country_brazil_state_bahia_negative"
    )  # This is the file to test this case
...
# Test RTB 2.4 bid request for CTV placement geo targeting country brazil state bahia negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb24_country_brazil_state_bahia_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb24_country_brazil_state_bahia_negative"
    )  # This is the file to test this case
...
# Test RTB 2.5 bid request for CTV placement geo targeting country brazil state bahia negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb25_country_brazil_state_bahia_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb25_country_brazil_state_bahia_negative"
    )  # This is the file to test this case
...
# Test RTB 2.6 bid request for CTV placement geo targeting country brazil state bahia negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb26_country_brazil_state_bahia_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb26_country_brazil_state_bahia_negative"
    )  # This is the file to test this case

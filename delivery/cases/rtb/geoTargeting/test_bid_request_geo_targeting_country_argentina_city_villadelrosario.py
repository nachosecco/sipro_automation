...
# Test RTB 2.2 bid request for geo targeting country argentina city Villa del Rosario.
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb22_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb22_valid"
...
# Test RTB 2.3 bid request for CTV placement geo targeting country argentina city Villa del Rosario.
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb23_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb23_valid"
    )  # This is the file to test this case
...
# Test RTB 2.4 bid request for CTV placement geo targeting country argentina city Villa del Rosario.
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb24_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb24_valid"
    )  # This is the file to test this case
...
# Test RTB 2.5 bid request for CTV placement geo targeting country argentina city Villa del Rosario.
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb25_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb25_valid"
    )  # This is the file to test this case
...
# Test RTB 2.6 bid request for CTV placement geo targeting country argentina city Villa del Rosario.
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb26_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb26_valid"
    )  # This is the file to test this case
...
# Test RTB 2.2 bid request for CTV placement geo targeting country argentina city Villa del Rosario negative
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb22_invalid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb22_invalid"
    )  # This is the file to test this case
...
# Test RTB 2.3 bid request for CTV placement geo targeting country argentina city Villa del Rosario negative
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb23_invalid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb23_invalid"
    )  # This is the file to test this case
...
# Test RTB 2.4 bid request for CTV placement geo targeting country argentina city Villa del Rosario negative
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb24_invalid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb24_invalid"
    )  # This is the file to test this case
...
# Test RTB 2.5 bid request for CTV placement geo targeting country argentina city Villa del Rosario negative
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb25_invalid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb25_invalid"
    )  # This is the file to test this case
...
# Test RTB 2.6 bid request for CTV placement geo targeting country argentina city Villa del Rosario negative
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb26_invalid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_city_villadelrosario_rtb26_invalid"
    )  # This is the file to test this case

...
# Test RTB 2.2 bid request for CTV placement geo targeting country canada state ontario
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb22_country_canada_state_ontario_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb22_country_canada_state_ontario_valid"
...
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb23_country_canada_state_ontario_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb23_country_canada_state_ontario_valid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb24_country_canada_state_ontario_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb24_country_canada_state_ontario_valid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb25_country_canada_state_ontario_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb25_country_canada_state_ontario_valid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb26_country_canada_state_ontario_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb26_country_canada_state_ontario_valid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb22_country_canada_state_ontario_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb22_country_canada_state_ontario_negative"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb23_country_canada_state_ontario_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb23_country_canada_state_ontario_negative"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb24_country_canada_state_ontario_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb24_country_canada_state_ontario_negative"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb25_country_canada_state_ontario_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb25_country_canada_state_ontario_negative"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb26_country_canada_state_ontario_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb26_country_canada_state_ontario_negative"
    )  # This is the file to test this case

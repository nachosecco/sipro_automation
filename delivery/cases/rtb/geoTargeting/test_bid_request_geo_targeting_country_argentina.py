...
def get_expected_device_object_rtb22(ip_address):
    ...
    expected_device = {
        ...
        "ifa": "09bf68e7-a187-517c-84c6-466bba9d3451",
    }
...
# Test RTB 2.2 bid request for geo targeting country argentina.
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_rtb22_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_rtb22_valid"
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_rtb23_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_rtb23_valid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_rtb24_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_rtb24_valid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_rtb25_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_rtb25_valid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_rtb26_valid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_rtb26_valid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_rtb22_invalid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_rtb22_invalid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_rtb23_invalid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_rtb23_invalid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_rtb24_invalid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_rtb24_invalid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_rtb25_invalid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_rtb25_invalid"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_geo_targeting_for_country_argentina_rtb26_invalid():
    case = Case(
        "test_bid_request_geo_targeting_for_country_argentina_rtb26_invalid"
    )  # This is the file to test this case

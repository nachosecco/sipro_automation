...
# Test RTB 2.2 bid request for CTV placement geo targeting country brazil
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb22_country_brazil_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb22_country_brazil_valid"
...
# Test RTB 2.3 bid request for CTV placement geo targeting country brazil
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb23_country_brazil_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb23_country_brazil_valid"
    )  # This is the file to test this case
...
# Test RTB 2.4 bid request for CTV placement geo targeting country brazil
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb24_country_brazil_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb24_country_brazil_valid"
    )  # This is the file to test this case
...
# Test RTB 2.5 bid request for CTV placement geo targeting country brazil
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb25_country_brazil_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb25_country_brazil_valid"
    )  # This is the file to test this case
...
# Test RTB 2.6 bid request for CTV placement geo targeting country brazil
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb26_country_brazil_valid():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb26_country_brazil_valid"
    )  # This is the file to test this case
...
# Test RTB 2.2 bid request for CTV placement geo targeting country brazil negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb22_country_brazil_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb22_country_brazil_negative"
    )  # This is the file to test this case

    vpc = case.vpc
    vpc.did = "fe088fc1-4cb4-548e-989b-6f8ff834e27d"
    vpc.ip_address = get_ip_not_for_geo(country="BR")
...
# Test RTB 2.3 bid request for CTV placement geo targeting country brazil negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb23_country_brazil_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb23_country_brazil_negative"
    )  # This is the file to test this case
...
# Test RTB 2.4 bid request for CTV placement geo targeting country brazil negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb24_country_brazil_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb24_country_brazil_negative"
    )  # This is the file to test this case
...
# Test RTB 2.5 bid request for CTV placement geo targeting country brazil negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb25_country_brazil_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb25_country_brazil_negative"
    )  # This is the file to test this case
...
# Test RTB 2.6 bid request for CTV placement geo targeting country brazil negative
@pytest.mark.regression
def test_bid_request_geo_targeting_ctv_rtb26_country_brazil_negative():
    case = Case(
        "test_bid_request_geo_targeting_ctv_rtb26_country_brazil_negative"
    )  # This is the file to test this case

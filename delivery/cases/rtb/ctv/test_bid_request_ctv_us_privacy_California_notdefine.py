...
def test_bid_request_ctv_us_privacy_california_notdefine_rtb22():
    root_domain = Configuration().root_domain
    case = Case(
        "test_bid_request_ctv_us_privacy_california_notdefine_rtb22"
...
@pytest.mark.regression
def test_bid_request_ctv_us_privacy_california_notdefine_rtb23():
    root_domain = Configuration().root_domain
    case = Case(
        "test_bid_request_ctv_us_privacy_california_notdefine_rtb23"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_ctv_us_privacy_california_notdefine_rtb24():
    root_domain = Configuration().root_domain
    case = Case(
        "test_bid_request_ctv_us_privacy_california_notdefine_rtb24"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_ctv_us_privacy_california_notdefine_rtb25():
    root_domain = Configuration().root_domain
    case = Case(
        "test_bid_request_ctv_us_privacy_california_notdefine_rtb25"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_ctv_us_privacy_california_notdefine_rtb26():
    root_domain = Configuration().root_domain
    case = Case(
        "test_bid_request_ctv_us_privacy_california_notdefine_rtb26"
    )  # This is the file to test this case

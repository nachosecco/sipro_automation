    ...
    expected_imp = [
        {
            ...
            "instl": 0,
            "tagid": "IJK7ETH9211C7A3NEOKH18M3O0",
            "bidfloor": 0.1,
            "bidfloorcur": "USD",
            "secure": 1,
            "exp": 14400,
...
def test_bid_request_ctv_imp_exp_rtb24():
    case = Case(
        "test_bid_request_ctv_imp_exp_rtb24"
    ...
    validate_rtb_ctv_common_properties(bid_request_validator)
...
@pytest.mark.regression
def test_bid_request_ctv_imp_exp_rtb25():
    case = Case(
        "test_bid_request_ctv_imp_exp_rtb25"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_bid_request_ctv_imp_exp_rtb26():
    case = Case(
        "test_bid_request_ctv_imp_exp_rtb26"
    )  # This is the file to test this case

...
def test_bid_request_ctv_us_privacy_connecticut_1NNN_rtb22():
    root_domain = Configuration().root_domain
    case = Case(
        "test_bid_request_ctv_us_privacy_connecticut_1NNN_rtb22"
    ...
    vpc.ip_address = get_ip_for_geo(
        country="US", region="Connecticut", city="Danbury", postcode="06470", dma="501"
    )
    ...
    validate_rtb_ctv_common_properties(
        bid_request_validator, "test_bid_request_ctv_us_privacy_connecticut_1NNN_rtb22"
    )
...
@pytest.mark.regression
def test_bid_request_ctv_us_privacy_connecticut_1NNN_rtb23():
    root_domain = Configuration().root_domain
    case = Case(
        "test_bid_request_ctv_us_privacy_connecticut_1NNN_rtb23"
    )  # This is the file to test this case
    ...
    validate_rtb_ctv_common_properties(
        bid_request_validator, "test_bid_request_ctv_us_privacy_connecticut_1NNN_rtb23"
    )
    assert bid_request_validator.is_device_object_as_expected(
...
@pytest.mark.regression
def test_bid_request_ctv_us_privacy_connecticut_1NNN_rtb24():
    root_domain = Configuration().root_domain
    case = Case(
        "test_bid_request_ctv_us_privacy_connecticut_1NNN_rtb24"
    )  # This is the file to test this case
    ...
    validate_rtb_ctv_common_properties(
        bid_request_validator, "test_bid_request_ctv_us_privacy_connecticut_1NNN_rtb24"
    )
    assert bid_request_validator.is_device_object_as_expected(
...
@pytest.mark.regression
def test_bid_request_ctv_us_privacy_connecticut_1NNN_rtb25():
    root_domain = Configuration().root_domain
    case = Case(
        "test_bid_request_ctv_us_privacy_connecticut_1NNN_rtb25"
    )  # This is the file to test this case
    ...
    validate_rtb_ctv_common_properties(
        bid_request_validator, "test_bid_request_ctv_us_privacy_connecticut_1NNN_rtb25"
    )
    assert bid_request_validator.is_device_object_as_expected(
        get_expected_device_object_rtb24(vpc.ip_address), True
    )
...
@pytest.mark.regression
def test_bid_request_ctv_us_privacy_connecticut_1NNN_rtb26():
    root_domain = Configuration().root_domain
    case = Case(
        "test_bid_request_ctv_us_privacy_connecticut_1NNN_rtb26"
    )  # This is the file to test this case
    ...
    validate_rtb_ctv_common_properties(
        bid_request_validator, "test_bid_request_ctv_us_privacy_connecticut_1NNN_rtb26"
    )
    assert bid_request_validator.is_device_object_as_expected(
        get_expected_device_object_rtb24(vpc.ip_address), True
    )

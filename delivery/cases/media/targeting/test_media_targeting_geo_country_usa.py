...
def test_media_targeting_geo_insertion_order_for_country_usa():
    case = Case(
        "test_media_targeting_geo_insertion_order_for_country_usa"
...
@pytest.mark.regression
def test_media_targeting_geo_campaign_for_country_usa():
    case = Case(
        "test_media_targeting_geo_campaign_for_country_usa"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_media_targeting_geo_media_for_country_usa():
    case = Case(
        "test_media_targeting_geo_media_for_country_usa"
    )  # This is the file to test this case
...
@pytest.mark.regression
def test_media_targeting_geo_insertion_order_for_country_usa_negative():
    case = Case(
        "test_media_targeting_geo_insertion_order_for_country_usa_negative"
    )  # This is the file to test this case

    vpc = case.vpc
    vpc.ip_address = get_ip_not_for_geo(country="US")

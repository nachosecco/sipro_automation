...
@dataclass
@athena_table("impression")
class AthenaTableImpression(AthenaTableCommon):
    """Fields of the table impression"""
    ...
    SEGMENTS = "segments"
    SEGMENT_CPM = "segment_cpm"
    DEMAND_PARTNER_FEE = "demand_partner_fee"
